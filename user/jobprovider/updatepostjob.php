...
<div class="shell">
		...
		<div class="range range-xs-center offset-top-0">
			<div class="cell-sm-10">
				<form data-form-output="form-output-global" data-form-type="contact" method="POST" action="updatepostjob.php" class="rd-mailform text-left offset-top-50" novalidate="novalidate">
						<div class="range" align="center">
							<div class="cell-md-6 offset-top-30 offset-md-top-0">
								<div class="form-group">
									...
									<input id="post-job-last-name" type="text" name="jname" class="form-control form-control-has-validation form-control-last-child" value="<?php echo $r['job_name']; ?>"</input>
								</div>
							</div>
							<div class="cell-md-6 offset-top-30">
								<div class="form-group">
									...
									<input id="post-job-company-name" type="text" name="designation" class="form-control form-control-has-validation form-control-last-child" value="<?php echo $r['designation']; ?>" </input>
								</div>
							</div>
							<div class="cell-md-6 offset-top-30">
								<div class="form-group">
									<label for="post-job-location" class="form-label form-label-outside text-sbold rd-input-label">No_Of_Vacancies</span></label>
									<input id="post-job-location" type="text" name="vacancy" required class="form-control form-control-has-validation form-control-last-child" value="<?php echo $r['no_of_vacancy']; ?>" </input>
								</div>
							</div>
							<div class="cell-md-6 offset-top-30">
								<div class="form-group">
									<label for="post-job-category" class="form-label form-label-outside text-sbold rd-input-label">Start_Date</label>
									<input type="date" name="start_date" class="form-control form-control-has-validation form-control-last-child" value="<?php echo $r['start_date']; ?>" </input>
								</div>
							</div>
							<div class="cell-lg-12">
								<div class="form-group">
									<label for="contact-me-message" class="form-label form-label-outside text-sbold rd-input-label">End_Date</label>
									<input type="date" name="end_date" class="form-control form-control-has-validation form-control-last-child" value="<?php echo $r['end_date']; ?>" </input>
								</div>
							</div>
							<div class="cell-lg-12">
								<div class="form-group">
									<label for="contact-me-message" class="form-label form-label-outside text-sbold rd-input-label">Qualificaton</label> 
										<select required name="qualification" class="form-control form-control-has-validation form-control-last-child">
											<option value=" "><?php echo $r['min_qualification']; ?></option>
							...
							<div class="cell-md-6 offset-top-30">
								<div class="form-group">
									...
									<input type="text" name="salary" class="form-control form-control-has-validation form-control-last-child" value="<?php echo $r['salary']; ?>" </input>
								</div>
							</div>
						</div>
	...
	if(isset($_POST['submit']))
		{
			...
			//$sql="insert into job (`job_id`, `job_name`, `designation`, `min_qualification`, `no_of_vacancy`, `salary`, `start_date`, `end_date`, `jobprovider_email`) VALUES  ('2','$jname','$desig','$qual','$vacancy','$salary','$sdate','$edate','jiwanprakashchoudhary@gmail.com')";
			  $sql="UPDATE `job` SET `job_name`='$jname',`designation`='$desig',`min_qualification`='$qual',`no_of_vacancy`='$vacancy',`salary`='$salary',`start_date`='$sdate',`end_date`='$edate' WHERE job_id='$job_id'";
